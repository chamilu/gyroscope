...
!(function (a) {
    ...
    function d() {
        o = n
            ? (a.screen.orientation.angle || 0) * j
            : (a.orientation || 0) * j;
    }
    function e(a) {
        ...
        (t.version = "0.5.3"),
            (t.getDeviceOrientation = function (a) {
                var b = new Promise(function (b, d) {
                    ...
                    f.then(function () {
                        (e._alphaAvailable =
                            l.orientation.data.alpha &&
                            null !== l.orientation.data.alpha),
                            (e._betaAvailable =
                                l.orientation.data.beta &&
                                null !== l.orientation.data.beta),
                            (e._gammaAvailable =
                                l.orientation.data.gamma &&
                                null !== l.orientation.data.gamma),
                            b(e);
                    })["catch"](function () {
                ...
                var b = new Promise(function (b, d) {
                    ...
                    f.then(function () {
                        (e._accelerationXAvailable =
                            ...
                            l.motion.data.acceleration.x),
                            (e._accelerationYAvailable =
                                l.motion.data.acceleration &&
                                l.motion.data.acceleration.y),
                            (e._accelerationZAvailable =
                                l.motion.data.acceleration &&
                                l.motion.data.acceleration.z),
                            ...
                            (e._rotationRateAlphaAvailable =
                                ...
                                l.motion.data.rotationRate.alpha),
                            (e._rotationRateBetaAvailable =
                                l.motion.data.rotationRate &&
                                l.motion.data.rotationRate.beta),
                            (e._rotationRateGammaAvailable =
                                l.motion.data.rotationRate &&
                                l.motion.data.rotationRate.gamma),
                            b(e);
                    })["catch"](function () {
            ...
            (t.Quaternion = function (a, c, d, e) {
                ...
                (this.set = function (a, b, c, d) {
                    ...
                    (this.multiply = function (a) {
                        return (
                            (f = t.Quaternion.prototype.multiplyQuaternions(
                                this,
                                a
                            )),
                            this.copy(f),
                ...
                rotateByAxisAngle: (function () {
                    ...
                    return function (e, f, g) {
                        return (
                            ...
                            (c = t.Quaternion.prototype.multiplyQuaternions(
                                e,
                                d
                            )),
            ...
            (t.RotationMatrix = function (a, b, c, d, e, f, g, h, i) {
                ...
                (this.elements = new Float32Array(9)),
                    ...
                    (this.multiply = function (a) {
                        return (
                            (k = t.RotationMatrix.prototype.multiplyMatrices(
                                this,
                                a
                            )),
                            this.copy(k),
                ...
                rotateByAxisAngle: (function () {
                    ...
                    return function (f, g, h) {
                        return (
                            ...
                            e
                                ? ((c =
                                      t.RotationMatrix.prototype.multiplyMatrices(
                                          f,
                                          d
                                      )),
            ...
            (t.Euler = function (a, b, c) {
                (this.set = function (a, b, c) {
                    ...
                    (this.rotateX = function (a) {
                        return (
                            t.Euler.prototype.rotateByAxisAngle(
                                this,
                                [1, 0, 0],
                                a
                            ),
            ...
            (t.Euler.prototype = {
                ...
                rotateByAxisAngle: (function () {
                    ...
                    return function (b, c, d) {
                        return (
                            a.setFromEuler(b),
                            (a = t.RotationMatrix.prototype.rotateByAxisAngle(
                                a,
                                c,
                                d
                            )),
            ...
            (t.DeviceOrientation.prototype = {
                ...
                start: function (b) {
                    b &&
                        ...
                        m ||
                            (n
                                ? a.screen.orientation.addEventListener(
                                      "change",
                                      d,
                                      !1
                                  )
                ...
                getScreenAdjustedQuaternion: (function () {
                    ...
                    return function () {
                        return (
                            (a = this.getFixedFrameQuaternion()),
                            a.rotateZ(-o),
                            a
                        );
                    };
                ...
                getScreenAdjustedMatrix: (function () {
                    ...
                    return function () {
                        return (
                            (a = this.getFixedFrameMatrix()), a.rotateZ(-o), a
                        );
                    };
                })(),
...
!(function (a, b) {
    ...
    return (
        ...
        (w.prototype.init = function (a) {
            ...
            var b = new FULLTILT.getDeviceOrientation({ type: s }).then(
                    function (a) {
                        o = a;
                    }
                ),
